 ...
 * 请提前取关至少250个商店确保京东试用脚本正常运行
 cron 20 10 * * * jd_tryCR.js
 * @LastEditTime: 2021-09-08 17:20:00
 * @LastEditors: X1a0He
 */
 //JD_TRY_WHITELISTKEYWORDS
const $ = new Env('京东成人试用')
...
let JD_TRY_WHITELISTKEYWORDS=["震动棒","自慰器","延时","成人","避孕","安全套","跳蛋","男士用品","飞机杯","自慰","阳具","高潮","套套","情趣","玩具"]
let JD_TRY=true;
let JD_TRY_WHITELIST="true"	
...
let args_xh = {
     ...
     * 默认为 1 到 5
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [2,13,16],
    /*
     ...
     * */
    whiteListKeywords: process.env.JD_TRY_WHITELISTKEYWORDS && process.env.JD_TRY_WHITELISTKEYWORDS.split('@') || ["震动棒@自慰器@延时@成人@避孕@安全套@跳蛋@男士用品@飞机杯@自慰@阳具@高潮@套套@情趣@玩具"],
    /*
     * 每多少个账号发送一次通知，默认为4
